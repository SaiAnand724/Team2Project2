...
import {
  ThemeProvider,
  useTheme,
} from "./Components/UtilityComponents/ThemeProvider";
...
const App: React.FC = () => {
  ...
  return (
    <div className={`app-container ${darkMode ? "dark-theme" : "light-theme"}`}>
      ...
      <main>
        {" "}
        {/*keeps the footer on the bottom of the page*/}
        <Routes>
          ...
          */}
          ...
          <Route
            path="/proposals-hist"
            element={<SponsorDetails proposals={[]} />}
          />
          ...
          */}
          ...
          <Route
            path="/player/team/invites"
            element={<TeamInviteContainer />}
          />
          <Route
            path="/player/sponsorships"
            element={<SponsorshipContainer />}
          />
        </Routes>
      </main>
      {showFooter && <Footer />}
